...
<body>
    ...
    <div id="menu-modal" class="md-modal md-effect-1">
        <div class="md-content">
            <ul>
                ...
                <li>
                    <a href="<?php echo $home; ?>/kontakta-oss"><?=$translate['contact']; ?></a>
                </li>
            </ul>
        </div>
        <div id="flags-menu">
    ...
    <header>
        <nav>
            ...
            <ul>
                <li class="menu-item"><a href="<?php echo $home; ?>"><?=$translate['home']; ?></a></li>
                ...
                <li class="menu-item"><a href="<?php echo $home; ?>/sponsorer">Sponsorer</a></li>
                <li id="more" class="sub menu-item">
                    <span>Mer <img src="<?php bloginfo('template_url'); ?>/img/more-red.png" alt=""></span>
                    <ul>
                        <li>
                            <a href="<?php echo $home; ?>/kontakta-oss" class="sub-link" data-modal="contact"><?=$translate['contact']; ?></a>
                        </li>
                        <li>
